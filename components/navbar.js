...
export default function Navbar({ user, isLoading }) {
    ...
    return (
        <div className={`bg-white md:bg-gray-50 shadow-[0_5px_35px_-15px_rgba(0,0,0,0.3)]  fixed z-30 bottom-0 left-0 md:top-0 md:left-0 md:w-16 md:h-screen w-full h-16 flex md:justify-center justify-end item-center`}>
